 ...
 *
 */
public class BeSmallerOrEqualToHandler extends CommonHandler implements IOperatorHandler {
	...
	public boolean calIfTypeIsString(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Small than or equal comparison can't be used to string value.");
	}
	...
	public boolean calIfTypeIsBoolean(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Small than or equal comparison can't be used to boolean value.");
	}
