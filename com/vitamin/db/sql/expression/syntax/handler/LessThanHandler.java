 ...
 *
 */
public class LessThanHandler extends CommonHandler implements IOperatorHandler {
	...
	public boolean calIfTypeIsBoolean(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Less than comparison can't be used to boolean value.");
	}
	...
	public boolean calIfTypeIsDate(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Less than comparison can't be used to date value.");
	}
