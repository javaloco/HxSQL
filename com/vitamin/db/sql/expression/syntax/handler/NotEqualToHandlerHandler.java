 ...
 * 529929513
 */
public class NotEqualToHandlerHandler extends CommonHandler implements IOperatorHandler {
	...
	public boolean calIfTypeIsDate(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("not equal comparison can't be used to date value.");
	}
}
