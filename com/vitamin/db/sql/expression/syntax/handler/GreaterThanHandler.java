 ...
 *
 */
public class GreaterThanHandler extends CommonHandler implements IOperatorHandler {
	...
	public boolean calIfTypeIsString(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Great than comparison can't be used to string value.");
	}
	...
	public boolean calIfTypeIsBoolean(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Great than comparison can't be used to boolean value.");
	}
	...
	public boolean calIfTypeIsDate(Object value, Object rightOperand) {
		throw new UnsupportedOperationException("Great than comparison can't be used to date value.");
	}
